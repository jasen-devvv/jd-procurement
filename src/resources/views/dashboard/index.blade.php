		...
		<div class="row">
			...
			<div class="card info-card order-card">
			  ...
			  <div class="filter">
				...
				<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
				  ...
				  <li><a class="dropdown-item" href="{{ route('dashboard', ['card' => 'order', 'period' => 'daily']) }}">Today</a></li>
				  <li><a class="dropdown-item" href="{{ route('dashboard', ['card' => 'order', 'period' => 'monthly']) }}">This Month</a></li>
				  <li><a class="dropdown-item" href="{{ route('dashboard', ['card' => 'order', 'period' => 'yearly']) }}">This Year</a></li>
				</ul>
			  </div>

			  <div class="card-body">
				<h5 class="card-title">Total Order <span>| {{ request()->get('period', 'daily') }}</span></h5>
				...
				<div class="d-flex align-items-center">
				  ...
				  <div class="ps-3">
					<h6>{{ $orderCount }}</h6>
					<span class="{{ $orderPercentageChange >= 0 ? 'text-success' : 'text-danger' }} small pt-1 fw-bold">
						{{ number_format($orderPercentageChange, 2) }}%
					</span>
					<span class="text-muted small pt-1 ps-1">
						{{ $orderPercentageChange >= 0 ? 'increase' : 'decrease' }}
					</span>
				  </div>
				</div>
		  ...
		  <div class="col-12">
			<div class="card">
			  ...
			  <div class="card-body">
				<h5 class="card-title">Reports Daily</h5>
...
<script>
	document.addEventListener("DOMContentLoaded", () => {
		...
		const orderSeries = allDates.map(date => getDataForDate(orderData, date));
